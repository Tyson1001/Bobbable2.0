...
export const mockDrinks: Drink[] = [
  ...
  },
  {
    ...
    category: 'milk-tea',
    popular: false,
    description: 'Creamy coconut milk tea',
    image_url: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
    ...
    category: 'milk-tea',
    popular: false,
    description: 'Sweet strawberry milk tea',
    image_url: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
    ...
    category: 'milk-tea',
    popular: false,
    description: 'Smooth vanilla milk tea',
    image_url: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
    ...
    category: 'milk-tea',
    popular: false,
    description: 'Nutty almond milk tea',
    image_url: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
    ...
    category: 'milk-tea',
    popular: false,
    description: 'Floral rose-flavored milk tea',
    image_url: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  }
